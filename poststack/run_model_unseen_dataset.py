...
#    Team 'Terra Pioneers' entry to the SPE Europe Energy Geohackathon 2023 run a model
#        to predict seismic inversion products on unseen poststack seismic data
#
